/*
  ...
  - A unique constraint covering the columns `[vessel_id,crew_member_id,item_id,consumption_date]` on the table `inventory_consumptions` will be added. If there are existing duplicate values, this will fail.

*/
-- DropIndex
DROP INDEX "idx_inventory_consumption_item";

-- DropIndex
DROP INDEX "inventory_consumptions_vessel_id_crew_member_id_item_id_mon_key";

-- DropIndex
DROP INDEX "idx_inventory_onsigner_item";
...
-- CreateIndex
CREATE UNIQUE INDEX "inventory_consumptions_vessel_id_crew_member_id_item_id_con_key" ON "inventory_consumptions"("vessel_id", "crew_member_id", "item_id", "consumption_date");
