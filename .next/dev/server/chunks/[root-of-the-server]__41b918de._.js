...
"[project]/app/api/slopchest/items/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accessControl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withVesselAccess"])(request, async (vesselId, userId)=>{
        try {
            const items = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].inventoryItem.findMany({
                where: {
                    vessel_id: vesselId,
...
async function POST(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accessControl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAdminAccess"])(request, async (userId)=>{
        try {
            ...
            const newItem = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].inventoryItem.create({
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41b918de._.js.map