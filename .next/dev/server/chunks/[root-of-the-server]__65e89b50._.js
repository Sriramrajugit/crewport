...
async function PUT(request, { params }) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accessControl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAdminAccess"])(request, async (userId)=>{
        try {
            ...
            if (password) updateData.password_hash = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$bcrypt$29$__["hash"](password, 10);
            ...
            if (selected_vessels && Array.isArray(selected_vessels)) {
                ...
                const targetUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
                    where: {
                        id: targetUserId
                    },
                    include: {
                ...
                // Delete old mappings
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user_vessels.deleteMany({
                    where: {
            ...
            // Return updated user
            const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
                where: {
                    id: targetUserId
                },
                include: {
...
async function DELETE(request, { params }) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accessControl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAdminAccess"])(request, async (userId)=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user_vessels.updateMany({
                where: {
                    user_id: targetUserId
                },
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65e89b50._.js.map