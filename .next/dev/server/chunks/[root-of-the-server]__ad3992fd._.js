...
"[project]/app/api/vessels/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // Check if user is admin
        const isAdmin = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accessControl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUserAdmin"])(userId);
        // Get user's assigned vessels (for both admin and non-admin users)
        const userVessels = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user_vessels.findMany({
            where: {
                user_id: userId,
                is_active: true
            },
        ...
        const assignedVesselIds = userVessels.map((uv)=>uv.vessel_id);
        ...
        if (companyId) {
            ...
            if (!whereClause.company_id) {
                const company = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].company.findFirst({
                    where: {
                        is_active: true
                    }
                });
        ...
        const vessels = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vessel.findMany({
            where: whereClause,
            orderBy: {
                vessel_name: 'asc'
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(vessels);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad3992fd._.js.map