...
async function POST(request) {
    try {
        ...
        const passwordMatch = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$bcrypt$29$__["compare"](password, user.password_hash);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveSession"])({
            userId: user.id,
            email: user.email,
            name: user.full_name,
            role: user.users_roles.role_name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac61f7a2._.js.map