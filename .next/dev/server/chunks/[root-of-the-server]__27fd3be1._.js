...
"[project]/app/api/masters/ports/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].port.count({
            where
        });
        // Fetch paginated results
        const ports = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].port.findMany({
            where,
            orderBy: {
                [sortBy]: 'asc'
            },
...
async function POST(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accessControl$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAdminAccess"])(request, async (userId)=>{
        try {
            ...
            const newPort = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].port.create({
                data: {
                    name: body.name,
                    code: body.code,
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newPort, {
                status: 201
            });
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__27fd3be1._.js.map