...
"[project]/app/api/dashboard/all-kpis/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        console.log(`[Dashboard] User ${userId} (${user?.email}) has ${userVessels.length} active vessel tags:`, userVessels.map((uv)=>uv.vessels.vessel_name));
        ...
        const vesselKPIs = await Promise.all(userVessels.map(async (uv)=>{
            ...
            const [pendingRequests, crewSignOnThisMonth, crewSignOffThisMonth, totalCrewOnboard, contractsExpiringIn30Days, hraTransitDays] = await Promise.all([
                // Count pending crew from already fetched data
                Promise.resolve(crewMembers.filter((c)=>c.onboarding_status?.toUpperCase() === 'PENDING').length),
                // Count crew signed on this month
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].crewMember.count({
                    where: {
                        vessel_id: vesselId,
                        sign_on_date: {
                            gte: firstDayOfMonth,
                ...
                crewIds.length > 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].crewHRAEntry.count({
                    where: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9bcd91fb._.js.map